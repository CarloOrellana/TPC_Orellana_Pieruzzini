        ...
        <h1 style="color: white; text-align: center; padding-top: 10px;">ABM Articulos</h1>
         ...
         <div class="row">
           ...
           <div class="col-md-3" style="text-align: center; margin: 1em 0; overflow: hidden;  padding-top: 30px;">
            <asp:Button ID="btnAgregar"  runat="server" Text="Alta Articulo" OnClick="btnAgregar_Click" CssClass="btn btn-outline-secondary" style="color:white; border-color:white; width:200px; height:50px;"/>
          </div> 
           ...
           <div class="col-md-3" style="text-align: center; margin: 1em 0; overflow: hidden;  padding-top: 30px;">
            <asp:Button ID="btnBaja" runat="server" Text="Baja Articulo" OnClick="btnBaja_Click" CssClass="btn btn-outline-secondary" style="color:white; border-color:white; width:200px; height:50px;"/>
             ...
             <div class="col-md-3" style="text-align: center; margin: 1em 0; overflow: hidden;  padding-top: 30px;">
            <asp:Button ID="btnModificar"  runat="server" Text="Modificar Articulo"  OnClick="btnModificar_Click" CssClass="btn btn-outline-secondary" style="color:white; border-color:white; width:200px; height:50px;"/>
          </div>
