<%@ Page Title="Modificar Materia Prima" Language="C#" AutoEventWireup="true" MasterPageFile="~/SiteAdministrador.Master" CodeBehind="ModificarMateriales.aspx.cs" Inherits="Web.ModificarMateriales" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="form-group" style="display: block; position: relative; width: auto; height: auto; margin: 20px auto; background-color: rgba(0,0,0, 0.1); border-radius: 5px; box-shadow: inset 1px 1px 0 0 #d5d7de, inset -1px -1px 0 0 rgba(0,0,0,0.2); background-image: -webkit-radial-gradient(top, circle cover, #4e7a89, #2e3441 80%);">
        ...
        <h1 style="color: white; text-align: center; padding-top: 10px;">Modificar Materia Prima</h1>
        <div class="container">
            <div class="row">
                <div class="col">
